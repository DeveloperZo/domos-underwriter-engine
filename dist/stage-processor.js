...
export class StageProcessor {
     ...
     */
    async processStage(dealPath, stageNumber) {
     ...
     */
    async loadStructuredDeal(dealPath) {
     ...
     */
    async loadFinancialSummary(dealPath) {
        try {
     ...
     */
    async analyzeStage(deal, tenants, financials, spec) {
        const findings = [];
        const metrics = {};
        const risks = [];
        const opportunities = [];
     ...
     */
    async makeStageDecision(analysis, spec) {
     ...
     */
    async saveStageOutput(dealPath, stageNumber, analysis, decision) {
     ...
     */
    async logToAuditTrail(dealPath, stageNumber, analysis, decision) {
    ...
    async loadStageSpecification(stageNumber) {
        const stageMap = {
...
//# sourceMappingURL=stage-processor.js.map